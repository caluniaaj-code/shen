...
<body>
    ...
    <section class="hero">
        <div class="hero-content">
            ...
            <p class="bio">
                Hello! My name is A.J. L. Calunia, born December 3, 2006. I am a curious, friendly, and determined person who enjoys learning new things and taking on challenges that help me grow. I value honesty, respect, and perseverance, and I strive to maintain a positive attitude in everything I do. In my free time, I enjoy playing sports, gaming, spending time with friends and family, and exploring topics that interest me.
            </p>
                ...
                <div class="card">
                    <div class="card-content">
                        <p style="line-height: 1.8; color: var(--text-secondary);">
                            I believe that personal growth comes from experience, continuous learning, and stepping outside of my comfort zone. I am always looking for opportunities to improve myself and discover new interests. My passion drives me to create solutions that make a difference.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="content-grid">
                <div class="card">
                    <h3>🏀 Basketball</h3>
                    <div class="card-content">
                        <p style="color: var(--text-secondary);">Passionate player and enthusiast. Basketball keeps me sharp and connected with the community.</p>
                    </div>
                </div>
                <div class="card">
                    <h3>🚴 Cycling</h3>
                    <div class="card-content">
                        <p style="color: var(--text-secondary);">Explorer of roads and trails. Cycling is my escape and my meditation.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="projects">
        <div class="container">
            ...
            <div class="project-card">
                ...
                <p>
                    <strong>Description:</strong> Proposing technology-based solutions to improve the operations and services of Maycel Hometel.
                </p>
                <p>
                    The plan aims to enhance efficiency in managing reservations, guest records, billing, and daily administrative tasks through the implementation of an integrated information system. By utilizing modern technologies and digital tools, the project seeks to streamline business processes, improve data accuracy, strengthen security, and provide a better overall experience for both management and guests.
                </p>
                <p style="color: var(--cyber-cyan);">
                    The proposed system supports informed decision-making and helps the establishment adapt to the growing demands of the hospitality industry.
                </p>
            </div>
        </div>
    </section>
            ...
            <div class="content-grid">
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <p style="color: var(--text-secondary); margin-top: 0.5rem;">BEYTE FEST EVENT</p>
                    </div>
                </div>
                <div class="card">
                    <h3>🥈 MTV Spoof</h3>
        ...
        <div class="container">
            ...
            <div class="content-grid">
                <div class="card">
                    ...
                    <div class="card-content">
                        <p style="color: var(--text-secondary);">Professional experience in delivery and catering operations. Managed customer orders, ensured timely service delivery, and maintained high standards of customer satisfaction.</p>
                    </div>
                </div>
            </div>
        </div>
...
</html>            border-bottom: 2px solid var(--cyber-cyan);
